...
class MockProjectLLMClient:
    async def generate_ideas(
        ...
        base_project_templates = [
            ...
            {"title_template": "AI-Powered {health_area} Symptom Checker (Conceptual)", "domain": "HealthTech/AI", "keywords": ["ai", "chatbot", "health"], "default_tech": ["Rasa/Dialogflow (Conceptual)", "Knowledge Base"]}, # Added default_tech
...
"""
    ...
    return prompt # This is a truncated representation; the full prompt from the previous correct step is intended here.
